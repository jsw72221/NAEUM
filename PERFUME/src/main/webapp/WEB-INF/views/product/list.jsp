					...
					<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<a href="#"> <img
									src="${ path }/images/planning/slider001.png"
									class="d-block w-100" alt="Slider Image 1">
								</a>
							</div>
							<div class="carousel-item">
								<a href="#"> <img
									src="${ path }/images/planning/slider002.png"
									class="d-block w-100" alt="Slider Image 2">
								</a>
							</div>
							<div class="carousel-item">
								<a href="#"> <img
									src="${ path }/images/planning/slider003.png"
			...
			<div id="section2">
				...
				<div id="section2_1">
					...
					<div id="s3">
						...
						<div id="s3_2" style="text-align: center; position: relative;">
							<div id="scent-detail" style="font-size: 12px; font-weight: bold; color: gray;">
								...
								프레쉬하고 기분까지 좋아지는 시트러스 향부터 풍성한 플로럴 그리고 <br> 따스함이 느껴지는 우디함까지,<br>
								6가지 향의 계열로 구분된 다양한 프레그런스 제품들을 만나보세요.
							</div>


							<div id="button-area">
								<button type="button" id="scent-detail-button">more
									detail</button>
					...
					<div id="s4">
						...
						<div id="scent-list">
							<div class="center">
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">CITRUS</div>
									<a href="${ path }/product/scent?no=1"><img
										src="https://img.freepik.com/free-photo/citrus-background-with-assorted-fresh-citrus-fruits_114579-9901.jpg?size=626&ext=jpg&ga=GA1.1.1462281178.1681576788&semt=sph"
										src="" id="big"></a>
								</div>
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">FRUITY</div>
									<a href="${ path }/product/scent?no=2"><img
										src="https://t4.ftcdn.net/jpg/05/12/54/69/240_F_512546992_UGywRqXpPQhyljBPI1HUuxjXLOojRzXe.jpg"
										src="" id="big"></a>
								</div>
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">SPICY</div>
									<a href="${ path }/product/scent?no=3"><img
										src="https://img.freepik.com/free-photo/still-life-of-cosmetic-products_23-2149163108.jpg?w=1060&t=st=1681578891~exp=1681579491~hmac=07489f94c2933710dbaeccb1b44abec4d2b2db3ea63a14633aa17c8b67cdfe21"
										src="" id="big"></a>
								</div>
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">FLORAL</div>
									<a href="${ path }/product/scent?no=4"><img
										src="https://img.freepik.com/free-photo/simplistic-pink-and-white-roses-and-copy-space-background_23-2148408316.jpg?size=626&ext=jpg&ga=GA1.2.1462281178.1681576788&semt=sph"
										src="" id="big"></a>
								</div>
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">WOODY</div>
									<a href="${ path }/product/scent?no=6"><img
										src="https://t3.ftcdn.net/jpg/04/98/69/46/240_F_498694611_qUPJVlIdwV2cTU1QXrka1HqR9ea8D7oC.jpg"
										src="" id="big"></a>
								</div>
								<div class="scentcate" style="position: relative;" data-id="3">
									<div class="scentname" style="position: absolute; bottom: 0;">LIGHTFLORAL</div>
									<a href="${ path }/product/scent?no=5"><img
										src="https://img.freepik.com/free-photo/bunch-of-fresh-twigs-and-plants-in-vase_23-2148104490.jpg?size=626&ext=jpg&ga=GA1.2.1462281178.1681576788&semt=ais"
										src="" id="big"></a>
								</div>
							...
							<div class="banner">
								<div class="btn_best">
									<div id="btn_wrap" style="position: relative;">
										<div
											style="position: absolute; color: black; width: 100%; text-align: left; bottom: 20px;">
											<a class="link" href="${ path }/product/bestlist">
											<h6 style="font-size: 25px; font-weight: bold;">BEST
												PRODUCT</h6>
												</a>
										</div>
										<img
											src="https://img.freepik.com/premium-photo/medicinal-herbs-and-tinctures-homeopathy-selective-focus_73944-28706.jpg?size=626&ext=jpg&ga=GA1.1.686292353.1680604484&semt=sph"
											class="" alt="...">
								...
								<div class="btn_sale">
									<div id="btn_wrap" style="position: relative;">
										<div
											style="position: absolute; color: gray; font-weight: bold; width: 100%; text-align: left; bottom: 20px;">
											<a class="link" href="${ path }/product/salelist">
												<h6 style="font-size: 25px; font-weight: bold;">SALE
													PRODUCT</h6>
											</a>
										</div>
										<img
											src="https://img.freepik.com/free-photo/top-view-closeup-of-white-daisy-flowers-floating-on-the-water_181624-38043.jpg?size=626&ext=jpg&ga=GA1.1.686292353.1680604484&semt=sph"
											class="" alt="...">
									</div>
								</div>
							</div>
					...
					<div id="s5">
						...
						<div id="s5_button">
							...
							<button class="gender" type="button" id="gender1" value="F" style="border: 1px solid;"
								onclick="location.href='${ path }/product/list?gender=F'">FEMME</button>
							&nbsp; &nbsp;
							...
							<button class="gender" type="button" id="gender1" value="F" 
								onclick="location.href='${ path }/product/list?gender=F'">FEMME</button>
							&nbsp; &nbsp;
							<button class="gender" type="button" id="gender1" value="M" style="border: 1px solid;"
								onclick="location.href='${ path }/product/list?gender=M'">HOMME</button></c:if>
									...
									<c:forEach var="product" items="${ brand }">
										...
										<c:if test="${not empty gender}">
                                         ...
                                         <c:if test="${empty gender}">
												...
												checked	onclick="location.href='${ path }/product/list?bn=${product.brand}'">${product.brand}
                                         </c:if></td>
												</c:if>
										...
										<c:if test="${not empty gender}">
												...
												onclick="location.href='${ path }/product/list?gender=${gender}&bn=${product.brand}'">${product.brand}
                                         </c:if> 
                                         <c:if test="${empty gender}">
												<input type="checkbox" name="brand" id="bn" class="brandselect"
												onclick="location.href='${ path }/product/list?bn=${product.brand}'">${product.brand}
                                         </c:if></td>
												</c:if>
						...
						<div id="productfilter">
							<c:choose>
								<c:when test="${not empty gender && not empty bn}">
									<a class="link"
										href="${ path }/product/list?gender=${gender}&bn=${bn}&sort=1">
										최신 상품 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&bn=${bn}&sort=2">
										낮은 가격 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&bn=${bn}&sort=3">
										높은 가격 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&bn=${bn}&sort=4">
										사용 후기</a>
								</c:when>
								<c:when test="${not empty gender && empty bn}">
									<a class="link"
										href="${ path }/product/list?gender=${gender}&sort=1"> 최신
										상품 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&sort=2"> 낮은
										가격 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&sort=3"> 높은
										가격 </a>
									<span class="bar">|</span>
									<a class="link"
										href="${ path }/product/list?gender=${gender}&sort=4"> 사용
										후기</a>
								</c:when>
								<c:when test="${empty gender && not empty bn}">
									<a class="link" href="${ path }/product/list?bn=${bn}&sort=1">
										최신 상품 </a>
									<span class="bar">|</span>
									<a class="link" href="${ path }/product/list?bn=${bn}&sort=2">
										낮은 가격 </a>
									<span class="bar">|</span>
									<a class="link" href="${ path }/product/list?bn=${bn}&sort=3">
										높은 가격 </a>
									<span class="bar">|</span>
									<a class="link" href="${ path }/product/list?bn=${bn}&sort=4">
										사용 후기</a>
								</c:when>
								<c:otherwise>
									<a class="link" href="${ path }/product/list?sort=1"> 최신 상품
									</a>
									<span class="bar">|</span>
									<a class="link" href="${ path }/product/list?sort=2"> 낮은 가격
									</a>
									<span class="bar">|</span>
									<a class="link" href="${ path }/product/list?sort=3"> 높은 가격
									</a>
									<span class="bar">|</span>
						...
						<div id="listwrap" style="position: relative;">
							...
							<div class="row">
								<c:if test="${empty list }">
									<div class=" col-lg-12"
										style="text-align: center; font-size: 25px;">조회된 검색 결과가
										없습니다.</div>
								...
								<c:forEach var="product" items="${ list }">
									...
									<fmt:formatDate value="${product.date}"
										pattern="yyyy-MM-dd hh:mm:ss" var="newdate" />

									<c:set var="sevenDayAfter"
										value="<%=new Date(new Date().getTime() + 60 * 60 * 24 * 1000 * 7)%>" />
									<fmt:formatDate value="${sevenDayAfter}"
										pattern="yyyy-MM-dd hh:mm:ss" var="sevenDayAfterStr" />
									...
									<div class="col-sm-6 col-lg-3">
										...
										<div class="card">
											<div id="card-img" style="position: relative;">
												...
												<c:forEach var="productfile"
													items="${ product.productfile }">
													<c:if test="${productfile.pfsort eq '1' }">
														<a href="${ path }/product/detail?no=${product.PNo}">
															<img
															src="${ path }/upload/product/${ productfile.pfrenamefilename}"
												...
												<div class="etcsymbols"
													...
													<c:if test="${not empty product.productlike }">
                                                        ...
                                                        <img
															src="${ path }/upload/product/icons8-하트-24.png"
...
<%-- 														pattern="yyyy-MM-dd" var="newdate" /> --%>
								...
								<h5 id="pname" style="font-size: 18px; font-weight: bold;"><a class="productlink" href="${ path }/product/detail?no=${product.PNo}">${product.name }
											...
											<div style="position: relative;">
												<c:forEach var="benefit" items="${product.benefit}"
													begin="0" end="0">
													<fmt:formatDate value="${benefit.bnenddate}"
														pattern="yyyy-MM-dd" var="enddate" />
													<c:if test="${not empty product.benefit }">
														<div
															style="position: absolute; height: 90%; width: 100%; text-align: right; padding: 1px;">
															<span class="badge badge-danger" id="discount">
																SALE <br> ${benefit.bnratio}%
															</span>
														</div>
														<!-- 원가 - (원가 * 할인율) = 세일가  -->
														...
														<fmt:parseNumber var="salepricerate"
															value="${benefit.bnratio/100}" />
														<fmt:parseNumber var="saleprice"
															value="${product.price*salepricerate}" />
														<fmt:parseNumber var="productsaleprice"
															value="${product.price-saleprice}" />
														<p class="card-text" id="pprice">
															<fmt:formatNumber value="${productsaleprice}"
																pattern="###,###" />
															<span style="font-size: 12px;">won</span> <br> <span
																class="originprice"> <fmt:formatNumber
																	value="${product.price}" pattern="###,###" /> <span
																class="originprice" style="font-size: 8px;">won</span></span>
														</p>
						...
						<div id="pagebar">
							...
							<c:choose>
								<c:when test="${not empty gender && not empty bn}">
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&bn=${bn}&page=1'">&lt;&lt;</button>
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&bn=${bn}&page=${ pageInfo.prevPage }'">&lt;</button>
									...
									<c:forEach begin="${ pageInfo.startPage }"
										...
										<c:choose>
											...
											<c:otherwise>
												<button
													onclick="location.href='${ path }/product/list?page=${ status.current }'">${ status.current }</button>
											</c:otherwise>
										</c:choose>
									</c:forEach>

									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&bn=${bn}&page=${ pageInfo.nextPage }'">&gt;</button>
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&bn=${bn}&page=${ pageInfo.maxPage }'">&gt;&gt;</button>

								</c:when>

								<c:when test="${not empty gender && empty bn}">
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&page=1'">&lt;&lt;</button>
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&page=${ pageInfo.prevPage }'">&lt;</button>
									...
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&page=${ pageInfo.nextPage }'">&gt;</button>
									<button
										onclick="location.href='${ path }/product/list?gender=${gender}&page=${ pageInfo.maxPage }'">&gt;&gt;</button>

								</c:when>

								<c:when test="${empty gender && not empty bn}">
									<button
										onclick="location.href='${ path }/product/list?bn=${bn}&page=1'">&lt;&lt;</button>
									<button
										onclick="location.href='${ path }/product/list?bn=${bn}&page=${ pageInfo.prevPage }'">&lt;</button>
									...
									<button
										onclick="location.href='${ path }/product/list?bn=${bn}&page=${ pageInfo.nextPage }'">&gt;</button>
									<button
										onclick="location.href='${ path }/product/list?bn=${bn}&page=${ pageInfo.maxPage }'">&gt;&gt;</button>
								</c:when>
								<c:otherwise>
									<button onclick="location.href='${ path }/product/list?page=1'">&lt;&lt;</button>
									<button
										onclick="location.href='${ path }/product/list?page=${ pageInfo.prevPage }'">&lt;</button>
									...
									<button
										onclick="location.href='${ path }/product/list?page=${ pageInfo.nextPage }'">&gt;</button>
									<button
										onclick="location.href='${ path }/product/list?page=${ pageInfo.maxPage }'">&gt;&gt;</button>
								</c:otherwise>
							</c:choose>
						</div>
...
$(document).ready(function(){
// 	$("input:checkbox[id='bn']").prop("checked", false);	
			
	function brandselect(bn) {
...
//             $(this).find('.like').css("visibility","visible");
